...
class Stitcher:
    def __init__(self):
        ...
        #önbelleğe alınmış homografi matrisini
        self.cacheDh=None 
    ...
    def stitch(self,images,ratio=0.75,reprojThresh=4.0):
        ...
        # iki görüntü arasındaki özellikleri eşleştirin
            ...
            # homografi matrisini önbelleğe al

            self.cacheDh=M[1]

        # önbelleğe alınmış homografi matrisini kullanarak # görüntüleri birleştirmek için bir perspektif dönüşümü uygulayın

        result=cv2.warpPerspective(imageA,self.cacheDh,(imageA.shape[1]+imageB.shape[1],imageA.shape[0])) # görüntüleri birleştirin
